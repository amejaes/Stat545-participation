...
gapminder$continent %>%
  str()
#OR class() to work out if it is a factor or not
#To work out the number of levels, you should run nlevels()
#To see the names of the levels, you should run levels()
...
five_countries = c("Egypt", "Haiti", "Romania", "Thailand", "Venezuela")
gap <- gapminder %>%
...
```{r}
five_gap_dropped <- gap %>% 
  droplevels()

five_gap_dropped$country %>%
  nlevels()
```
